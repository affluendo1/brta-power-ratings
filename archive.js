(()=>{
  ...
  const archiveMedia=['assets/sid-throne-hero.png','assets/sid-federer-handshake.png','assets/sid-federer-kneeling.png','assets/sid-honour-plaque-transparent.png','assets/sid-wilson-blade.png','assets/royal-court-sunset.jpg','assets/royal-crowd.jpg',...wins.map(win=>win.src)];
  ...
  function portalMarkup(){
    ...
    return `<div class="archive-intro" aria-live="polite" aria-atomic="true" hidden><p>ACCESSING ROYAL ARCHIVE…</p></div><div class="royal-atmosphere" aria-hidden="true">${symbols}</div><div class="royal-quote-field">${quotes}</div>
      ...
      <section class="archive-section royal-colour-gallery"><figure class="royal-colour-photo"><img src="assets/royal-crowd.jpg" decoding="async" alt="A packed tennis crowd in colourful stadium seating."><figcaption>THE WITNESSES · PARIS</figcaption></figure><figure class="royal-colour-photo sunset"><img src="assets/royal-court-sunset.jpg" decoding="async" alt="A blue tennis court under a dramatic sunset."><figcaption>THE COURT AFTER DARK</figcaption></figure><aside class="archive-testimonial testimonial-djokovic"><small>FICTIONAL ARCHIVE INTERVIEW · 2027</small><blockquote>“The crowd can feel when someone owns the moment. Against Basa, the silence before the next point was louder than the stadium.”</blockquote><cite>— Novak Djokovic</cite></aside></section>
      ...
      <div class="archive-lightbox hidden" data-lightbox role="dialog" aria-modal="true" aria-label="Enlarged archive image"><button type="button" data-lightbox-close aria-label="Close image">×</button><img data-lightbox-image alt=""></div>
